...
class Logo(unittest.TestCase):
    ...
    def test_Logo_class_is_found(self):
        ...
        driver = self.driver
        assert (driver.find_element_by_xpath("//*[@id='homepage']/section[4]/div[1]/div[1]/a"))


    def test_Logo_image_is_found(self):

        driver = self.driver
        example_images = driver.find_elements(By.XPATH, '//section[4]/div[1]/div[1]/a/img')
    ...
    def test_Logo_is_clickable(self):
        ...
        driver = self.driver
        element = driver.find_element_by_xpath("//*[@id='homepage']/section[4]/div[1]/div[1]/a")
